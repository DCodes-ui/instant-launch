    ...
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center">
      ...
      <main className="flex-grow container mx-auto flex flex-col items-center justify-center px-6 pt-24">
        <section className="text-center py-12">
          ...
          <div className="mt-8">
            <a href="/enterprise-project.zip" download className="px-8 py-3 bg-green-500 text-white text-lg font-semibold rounded hover:bg-green-700 transition duration-300">
